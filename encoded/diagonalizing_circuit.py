#@title https://github.com/teaguetomesh/vqe-term-grouping/blob/master/generate_measurement_circuit.py
import qiskit as qk
import numpy as np
from copy import deepcopy

# TODO: We don't need to reduce Z to I.
# TODO: Convert list of strings to stabilizer matrix.
# Do this by conjugating under the measurment circuit unitary. 
# This can be done more easily by exploiting Clifford conjugation
# rules. 
...
def get_measurement_circuit(stabilizer_matrix, N):
...
def _terminate_with_measurements(measurement_circuit):
    ...
    # measurement_circuit.circuit.measure_active()
